...
class ImuMSCKF:
    ...
    """
    Apply update
    [in]: stacked_innovations = array containing innovation, dims = Mx1
    [in]: stacked_H = jacobian matrix, dims = Mx9*self.state.N+15 
    [in]: stacked_R = noise matrix, dims = MxM
    """
...
def propagate_covariance(A_aug, B_aug, dt, Sigma, W, Q):
    """
    :param A_aug:
    :param B_aug: [15 x 6] or [15+9 x 6]
    :return:
    """
